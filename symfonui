...
echo "-------------------------------------------------------------------------";
echo "     *                            *                                 *      ";
echo "        \033[33m______________\033[0m                                   *                 ";
echo "       \033[33m//  __________/\033[0m       \033[34mSIMPLE SYMFONY GUI BY\033[0m                        ";
echo "      \033[33m//  /____   _________  _________  ___________  ________  __________\033[0m  ";
echo "     \033[33m//  _____/  // ____  / //  _____/ //___   ___/ //  ____/ //  ___   /\033[0m  ";
echo "    \033[33m//  /       // /   / / //  /___       //  /    //  /___  //  /__/  / \033[0m  ";
echo "   \033[33m//  /       // /   / / //___   /      //  /    //  ____/ //    ____/  \033[0m  ";
echo "  \033[33m//  /       // /___/ / ____//  /      //  /    //  /___  //  /\  \     \033[0m  ";
echo " \033[33m//__/       //_______/ //_____ /      //__/    //______/ //__/  \__\    \033[0m  ";
echo "    *                                *                         *           ";
echo "                  *                                *                       ";
}
